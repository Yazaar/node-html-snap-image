...
export type ScreenshotType<TE extends Encoding | undefined> = TE extends 'base64' ? string : Buffer;
...
type EnsureArrayKeys<TA extends Content | undefined, TD> = TA extends Array<infer U> ? Array<U & TD> : TA;
...
export interface ScreenshotParams<TE extends Encoding | undefined, TC extends Content | undefined> {
  html: string;
  encoding?: TE;
  transparent?: boolean;
  type?: ImageType;
...
// Options for the Puppeteer cluster and also extends in the parameters for the screenshot processing.
export interface Options<TE extends Encoding | undefined, TC extends Content | undefined>
  extends ScreenshotParams<TE, TC>, Omit<MakeScreenshotParams<TE, TC>, 'screenshot'> {
...
export interface MakeScreenshotParams<TE extends Encoding | undefined, TC extends Content | undefined> {
